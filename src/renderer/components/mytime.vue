<template>
  <div>
	...
	<!--  <i class="el-icon-video-play anniu" v-show="isStart===false" v-on:click="$emit('startCount')">开始</i>
	  <i class="el-icon-video-pause anniu" v-show="isStart===true" v-on:click="$emit('stopCount')">结束</i> -->
	  
	 <a @click="$emit(isStart?'stopCount':'startCount')"> <svg-icon :icon-class="isStart?'stop':'play'"  />
	 ...
	 <!-- <a @click="$emit('stopCount')"> <svg-icon icon-class="stop" v-show="isStart===true"  /></a> -->
